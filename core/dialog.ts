...
let confirmImplementation = function (message: string, callback: (result: boolean) => void) {
  // @ts-ignore
...
let promptImplementation = function (message: string, defaultValue: string, callback: (result: string | null) => void) {
  // @ts-ignore
 ...
 */
export function setConfirm(confirmFunction: (p1: string, p2: (p1: boolean) => void) => void) {
 ...
 */
export function prompt(message: string, defaultValue: string, callback: (p1: string | null) => void) {
 ...
 */
export function setPrompt(promptFunction: (p1: string, p2: string, p3: (p1: string | null) => void) => void) {
